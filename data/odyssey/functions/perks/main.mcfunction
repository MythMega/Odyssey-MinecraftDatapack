#if locked = 0
#if unlocked and not selected = 1
#if unlocked and selected = 2


execute as @a at @s if score @s icemelter matches 2 run function odyssey:perks/icemelter
execute as @a at @s if score @s timejumper matches 2 run function odyssey:perks/timejumper
execute as @a at @s if score @s coinsradar matches 2 run function odyssey:perks/coinsradar
